...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.is_active'
        db.add_column(u'choiceNet_invoice', 'is_active',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Invoice.is_active'
        db.delete_column(u'choiceNet_invoice', 'is_active')
