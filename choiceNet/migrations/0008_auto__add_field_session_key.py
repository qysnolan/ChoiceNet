...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.key'
        db.add_column(u'choiceNet_session', 'key',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.key'
        db.delete_column(u'choiceNet_session', 'key')
    ...
    models = {
        ...
        u'choiceNet.session': {
            ...
            'key': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
