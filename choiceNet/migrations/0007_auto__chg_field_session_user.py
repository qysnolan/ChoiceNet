...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'choiceNet_session', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.User']))

    def backwards(self, orm):

        # Changing field 'Session.user'
        db.alter_column(u'choiceNet_session', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 4, 30, 0, 0), to=orm['accounts.User']))
