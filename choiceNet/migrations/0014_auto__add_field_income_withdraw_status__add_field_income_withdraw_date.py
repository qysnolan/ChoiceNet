...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Income.withdraw_status'
        db.add_column(u'choiceNet_income', 'withdraw_status',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Income.withdraw_date'
        db.add_column(u'choiceNet_income', 'withdraw_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Income.withdraw_status'
        db.delete_column(u'choiceNet_income', 'withdraw_status')

        # Deleting field 'Income.withdraw_date'
        db.delete_column(u'choiceNet_income', 'withdraw_date')
