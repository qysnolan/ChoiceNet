...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InvoiceCollection'
        db.create_table(u'choiceNet_invoicecollection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='collection_invoice', to=orm['choiceNet.Invoice'])),
        ))
        db.send_create_signal(u'choiceNet', ['InvoiceCollection'])

        # Adding M2M table for field collection on 'InvoiceCollection'
        m2m_table_name = db.shorten_name(u'choiceNet_invoicecollection_collection')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('invoicecollection', models.ForeignKey(orm[u'choiceNet.invoicecollection'], null=False)),
            ('invoice', models.ForeignKey(orm[u'choiceNet.invoice'], null=False))
        ))
        db.create_unique(m2m_table_name, ['invoicecollection_id', 'invoice_id'])


    def backwards(self, orm):
        # Deleting model 'InvoiceCollection'
        db.delete_table(u'choiceNet_invoicecollection')

        # Removing M2M table for field collection on 'InvoiceCollection'
        db.delete_table(db.shorten_name(u'choiceNet_invoicecollection_collection'))
    ...
    models = {
        ...
        u'choiceNet.income': {
            ...
            'withdraw_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'withdraw_status': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '128', 'null': 'True', 'blank': 'True'})
        },
        u'choiceNet.invoice': {
        ...
        u'choiceNet.invoicecollection': {
            'Meta': {'ordering': "['invoice']", 'object_name': 'InvoiceCollection'},
            'collection': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['choiceNet.Invoice']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'collection_invoice'", 'to': u"orm['choiceNet.Invoice']"})
        },
        u'choiceNet.session': {
