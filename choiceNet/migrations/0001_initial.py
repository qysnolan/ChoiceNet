...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'choiceNet_invoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')()),
            ('buyer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoice_buyer', to=orm['accounts.User'])),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoice_service', to=orm['service.Service'])),
            ('number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('amount', self.gf('django.db.models.fields.IntegerField')(max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal(u'choiceNet', ['Invoice'])


    def backwards(self, orm):
        # Deleting model 'Invoice'
        db.delete_table(u'choiceNet_invoice')
