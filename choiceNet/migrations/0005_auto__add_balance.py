...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'choiceNet_balance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='balance_user', to=orm['accounts.User'])),
            ('balance', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
        ))
        db.send_create_signal(u'choiceNet', ['Balance'])


    def backwards(self, orm):
        # Deleting model 'Balance'
        db.delete_table(u'choiceNet_balance')
