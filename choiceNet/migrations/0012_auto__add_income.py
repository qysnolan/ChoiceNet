...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Income'
        db.create_table(u'choiceNet_income', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(related_name='income_user', to=orm['accounts.User'])),
            ('income', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=12, blank=True)),
            ('updated_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'choiceNet', ['Income'])


    def backwards(self, orm):
        # Deleting model 'Income'
        db.delete_table(u'choiceNet_income')
