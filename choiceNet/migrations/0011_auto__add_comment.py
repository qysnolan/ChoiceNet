...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'choiceNet_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment_service', to=orm['service.Service'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment_user', to=orm['accounts.User'])),
            ('rate', self.gf('django.db.models.fields.IntegerField')(default=3)),
            ('comment', self.gf('django.db.models.fields.CharField')(default='0', max_length=4096, null=True, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_provider', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'choiceNet', ['Comment'])


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table(u'choiceNet_comment')
    ...
    models = {
        ...
        u'choiceNet.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_provider': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
