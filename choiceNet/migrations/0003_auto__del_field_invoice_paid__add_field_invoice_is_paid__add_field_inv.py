...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'choiceNet_invoice', 'paid')

        # Adding field 'Invoice.is_paid'
        db.add_column(u'choiceNet_invoice', 'is_paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Invoice.s_active'
        db.add_column(u'choiceNet_invoice', 's_active',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'choiceNet_invoice', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Invoice.is_paid'
        db.delete_column(u'choiceNet_invoice', 'is_paid')

        # Deleting field 'Invoice.s_active'
        db.delete_column(u'choiceNet_invoice', 's_active')
    ...
    models = {
        ...
        u'choiceNet.invoice': {
            ...
            's_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
