...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Balance.balance'
        db.alter_column(u'choiceNet_balance', 'balance', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=64, decimal_places=12))

    def backwards(self, orm):

        # Changing field 'Balance.balance'
        db.alter_column(u'choiceNet_balance', 'balance', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=64, decimal_places=2))
