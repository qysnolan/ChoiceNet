...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_user', (
            ...
            ('username', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=70)),
            ...
            ('isSuper', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('accountType', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
