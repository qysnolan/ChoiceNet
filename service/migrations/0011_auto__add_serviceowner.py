...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServiceOwner'
        db.create_table(u'service_serviceowner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='service_owner_owner', null=True, to=orm['accounts.User'])),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='service_owner_service', null=True, to=orm['service.Service'])),
            ('share_cost', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=64, decimal_places=12)),
        ))
        db.send_create_signal(u'service', ['ServiceOwner'])


    def backwards(self, orm):
        # Deleting model 'ServiceOwner'
        db.delete_table(u'service_serviceowner')
