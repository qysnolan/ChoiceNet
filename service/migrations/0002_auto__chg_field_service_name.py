...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'service_service', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Service.name'
        db.alter_column(u'service_service', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
