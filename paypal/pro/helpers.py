...
class PayPalWPP(object):
    ...
    https://cms.paypal.com/cms_content/US/en_US/static/developer/PP_WPP_IntegrationGuide.pdf

    Name-Value Pair API Developer Guide and Reference:
    https://cms.paypal.com/cms_content/US/en_US/static/developer/PP_NVPAPI_DeveloperGuide.pdf
    """
